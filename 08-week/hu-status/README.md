...
| HU-000-016 | Carried over — As the team, we want DOCS's API contracts to reflect the real auth model (HS512/24h, real roles), so `07-api` stops contradicting `AuthService` | doing, progressed (still open, teacher approval pending) | DOCS [PR #16](https://github.com/code-corhuila/barber-saas-docs/pull/16), branch `docs/004-align-api-contracts`: rebased onto `main` and added `07-api/open-questions.md` (3 real contract gaps with owner + closing criterion) in [`47bbe9b`](https://github.com/code-corhuila/barber-saas-docs/commit/47bbe9b) (2026-09-24), then answered all 3 of `ariel5253`'s SPEC-004 review recommendations in [`3034740`](https://github.com/code-corhuila/barber-saas-docs/commit/3034740) + [PR comment](https://github.com/code-corhuila/barber-saas-docs/pull/16#issuecomment-5814896761) |
